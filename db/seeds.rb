...
# --- PARTE 2: CÓDIGO PARA O ARQUIVO `db/seeds.rb` ---
...
# --- PARTE 3: COMANDO FINAL PARA EXECUTAR NO TERMINAL ---

# Depois de salvar o arquivo `db/seeds.rb`, volte ao terminal
# e execute o comando abaixo para popular o seu banco de dados.